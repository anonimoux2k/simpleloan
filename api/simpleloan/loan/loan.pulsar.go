...
func init() {
	...
	md_Loan = File_simpleloan_loan_loan_proto.Messages().ByName("Loan")
...
func (x *Loan) slowProtoReflect() protoreflect.Message {
	mi := &file_simpleloan_loan_loan_proto_msgTypes[0]
...
func (x *fastReflection_Loan) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "simpleloan.loan.Loan.id":
		return x.Id != uint64(0)
	case "simpleloan.loan.Loan.amount":
		return x.Amount != ""
	case "simpleloan.loan.Loan.fee":
		return x.Fee != ""
	case "simpleloan.loan.Loan.collateral":
		return x.Collateral != ""
	case "simpleloan.loan.Loan.deadline":
		return x.Deadline != ""
	case "simpleloan.loan.Loan.state":
		return x.State != ""
	case "simpleloan.loan.Loan.borrower":
		return x.Borrower != ""
	case "simpleloan.loan.Loan.lender":
		return x.Lender != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: simpleloan.loan.Loan"))
		}
		panic(fmt.Errorf("message simpleloan.loan.Loan does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Loan) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message simpleloan.loan.Loan does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Loan) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "simpleloan.loan.Loan.id":
		panic(fmt.Errorf("field id of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.amount":
		panic(fmt.Errorf("field amount of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.fee":
		panic(fmt.Errorf("field fee of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.collateral":
		panic(fmt.Errorf("field collateral of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.deadline":
		panic(fmt.Errorf("field deadline of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.state":
		panic(fmt.Errorf("field state of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.borrower":
		panic(fmt.Errorf("field borrower of message simpleloan.loan.Loan is not mutable"))
	case "simpleloan.loan.Loan.lender":
		panic(fmt.Errorf("field lender of message simpleloan.loan.Loan is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: simpleloan.loan.Loan"))
		}
...
func (x *fastReflection_Loan) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in simpleloan.loan.Loan", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: simpleloan/loan/loan.proto
...
func (*Loan) Descriptor() ([]byte, []int) {
	return file_simpleloan_loan_loan_proto_rawDescGZIP(), []int{0}
}
...
var File_simpleloan_loan_loan_proto protoreflect.FileDescriptor

var file_simpleloan_loan_loan_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x6c, 0x6f, 0x61, 0x6e, 0x2f, 0x6c, 0x6f, 0x61,
	0x6e, 0x2f, 0x6c, 0x6f, 0x61, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x73, 0x69,
	0x6d, 0x70, 0x6c, 0x65, 0x6c, 0x6f, 0x61, 0x6e, 0x2e, 0x6c, 0x6f, 0x61, 0x6e, 0x22, 0xc6, 0x01,
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x18, 0x04,
	...
	,
}

var (
	file_simpleloan_loan_loan_proto_rawDescOnce sync.Once
	file_simpleloan_loan_loan_proto_rawDescData = file_simpleloan_loan_loan_proto_rawDesc
)

func file_simpleloan_loan_loan_proto_rawDescGZIP() []byte {
	file_simpleloan_loan_loan_proto_rawDescOnce.Do(func() {
		file_simpleloan_loan_loan_proto_rawDescData = protoimpl.X.CompressGZIP(file_simpleloan_loan_loan_proto_rawDescData)
	})
	return file_simpleloan_loan_loan_proto_rawDescData
}

var file_simpleloan_loan_loan_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_simpleloan_loan_loan_proto_goTypes = []interface{}{
	(*Loan)(nil), // 0: simpleloan.loan.Loan
}
var file_simpleloan_loan_loan_proto_depIdxs = []int32{
...
func init() { file_simpleloan_loan_loan_proto_init() }
func file_simpleloan_loan_loan_proto_init() {
	if File_simpleloan_loan_loan_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_simpleloan_loan_loan_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Loan); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_simpleloan_loan_loan_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_simpleloan_loan_loan_proto_goTypes,
		DependencyIndexes: file_simpleloan_loan_loan_proto_depIdxs,
		MessageInfos:      file_simpleloan_loan_loan_proto_msgTypes,
	}.Build()
	File_simpleloan_loan_loan_proto = out.File
	file_simpleloan_loan_loan_proto_rawDesc = nil
	file_simpleloan_loan_loan_proto_goTypes = nil
	file_simpleloan_loan_loan_proto_depIdxs = nil
}
